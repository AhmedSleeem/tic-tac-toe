...
public class SavePointMulti extends AnchorPane {
    ...
    public SavePointMulti(GameRecorder gameRecorder) throws FileNotFoundException, SQLException {
        ...
        mysql.insertGame(gameRecorder.getPlayer1(), gameRecorder.getPlayer2(), gameRecorder.getWinner(), 
            ...
            ArrayList<String> finalRecord = mysql.getFinalRecord();
            gameRecorder.setPlayer1(finalRecord.get(0));
            gameRecorder.setPlayer2(finalRecord.get(1));
            gameRecorder.setWinner(finalRecord.get(2));
            gameRecorder.setPos1(Integer.parseInt(finalRecord.get(3)));
            gameRecorder.setPos2(Integer.parseInt(finalRecord.get(4)));
            gameRecorder.setPos3(Integer.parseInt(finalRecord.get(5)));
            gameRecorder.setPos4(Integer.parseInt(finalRecord.get(6)));
            gameRecorder.setPos5(Integer.parseInt(finalRecord.get(7)));
            gameRecorder.setPos6(Integer.parseInt(finalRecord.get(8)));
            gameRecorder.setPos7(Integer.parseInt(finalRecord.get(9)));
            gameRecorder.setPos8(Integer.parseInt(finalRecord.get(10)));
            gameRecorder.setPos9(Integer.parseInt(finalRecord.get(11)));
